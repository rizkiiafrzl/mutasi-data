<template>
  <div class="upload-upah-page">
    <v-container>
      <!-- Page Header -->
      <div class="page-header mb-6">
        <div class="d-flex align-center justify-space-between">
          <div>
            <h1 class="page-title">Upload Upah Massal</h1>
            <p class="page-subtitle">Upload data upah tenaga kerja secara massal</p>
          </div>
        </div>
      </div>
...
const breadcrumbs = ref([
  ...
  { title: 'Upload Upah', disabled: true },
])
...
const handleUpload = async () => {
  ...
  try {
    ...
    alert(error?.message || 'Gagal mengupload file upah. Silakan coba lagi.')
  } finally {
...
const downloadTemplate = async () => {
  try {
    ...
    link.download = 'template_upah_24101780.xlsx'
